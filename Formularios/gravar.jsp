...
<body class="bg-secondary text-white">
	...
	p.setIdesporte(Integer.parseInt(request.getParameter("idesporte")));
	p.setModalidade(request.getParameter("modalidade"));
	p.setSexo(request.getParameter("sexo"));
	p.setNumero_participantes(request.getParameter("numero_participantes"));
	p.setDuracao(request.getParameter("duracao"));

	// Verifica se deve alterar ou inserir
	dao.salvar(p);
	%>
	...
	<h1>Esporte salvo com sucesso!</h1><br/>
	<a href="index.jsp" class="btn btn-info"><h7 class="text-white">Voltar</h7></a>    <a href="listar.jsp"  class="btn btn-info"><h7 class="text-white">Listar</h7></a><br/><br/><br/><br/><br/><br/><br/>
	<footer>
